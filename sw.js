const VERSION='gc-static-v3-module-themes';
const SHELL=['./','index.html','manifest.webmanifest','assets/css/app.css','assets/js/app.js','assets/js/config.js','assets/js/core/html.js','assets/js/modules/english/explanations.js','assets/js/modules/academic/phrases.js','assets/js/services/topics.js','assets/js/services/professor.js','assets/js/modules/professor/render.js','assets/js/services/scoring.js','assets/js/services/timer.js','assets/js/services/question-cycles.js','assets/js/services/storage.js','assets/js/services/stats.js','assets/js/services/supabase.js','assets/icons/icon.svg','assets/icons/icon-192.png','assets/icons/icon-512.png'];
const BANKS=['data/english/official.json','data/english/training.json','data/orthography/official.json','data/orthography/training.json','data/grammar/official.json','data/grammar/training.json','data/grammar/explanations.json','data/professor/rules.json','data/professor/english.json','data/professor/orthography.json','data/professor/grammar.json'];
